...
title: HuggingFace
description: >
  How to use KRS with HuggingFace
date: 2017-01-05
weight: 6
---


Leverage HuggingFace's powerful language models to enhance Krs' problem-solving and recommendation capabilities.
...
2. **Choose 2 to Select HuggingFace as Your LLM provider** 
    The user is prompted to choose a model provider for the health check. Select option "2", and all necessary libraries will be installed.
